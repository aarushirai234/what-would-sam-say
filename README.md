...
- **Podcast** — downloaded and transcribed via Whisper (1 episode, ~45 mins)
...
- **Prototype vector DB** — ChromaDB works well at this scale. At NYT-scale query 
